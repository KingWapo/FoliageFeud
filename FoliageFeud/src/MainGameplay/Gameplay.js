...
var gameplay = {
	...
	introConvo: ["You are up! I have taken your brother's assistant.  This is merely phase one of my revenge!" , "Hey! That is my assistant. How dare you mess with me, you sad excuse for a carrot.", "Carrot!? How dare you!!! I am the dreaded Dr. Parsnip!","You are just another one of my failed experiments, now return my assistant!", "Sorry to interupt, but that is my fiance...also why do you look so old?","..I was trying to age myself to get a discount on chemicals...after I did this I heard the chemicals weren't even labeled. I regret my decision.","You are a mad scientist who can't afford supplies?", "The hat buisness has been slow thanks to that thing that took your beloved fiance","It is all part of my plan. As a product of nature I shall claim it for myself. Only I can master its knowledge.", "Well now he ran off, hurry brother, get to that bouncing exclamation point I have set up", " I can't swim..or climb..","Well lucky for you I have placed my new power coins near by. Gather them and you will instantly learn how to pass over any obstacle.","For a price I will even give you the newer models.", "You are making a profit off me losing my fiance..", "Maybe my next experiment will be made with non-discount chemicals and won't try to take over the natural world.", " Fine! I'll help you, but only because the wedding is coming up."],
	...
	render: function()
	{
		...
		if (!this.introStoryDone)
		{
			utility.drawTextBox(this.introConvo, "not in use", function(){gameplay.introStoryDone = true;});
			...
			switch(utility.textIndex)
			{
				...
				case 14:
					...
					else
					{
						utility.drawImage
						(
							menuSurface, imgShopSibling2,
							0, 0, imgShopSibling2.width, imgShopSibling2.height,
							400, 250, imgShopSibling2.width, imgShopSibling2.height
						);
					}
					break;
			}
