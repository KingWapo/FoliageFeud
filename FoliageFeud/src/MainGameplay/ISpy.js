...
var ispy = {
	...
	gameEnd: false,
	isCorrect: false,
	dingleBotFailResponses: ["Hmmm, not the one I would have chosen.. Oh well, Come back to base and I'll give you a chance to redeem yourself.", "Wow, you must really not pay attention to my training.", "Well obviously it wasn't that plant.", "Is that your final answer? Yes? Well, uh, no."],
	dingleBotWinResponses: ["You make this look easy. Come back to base and I'll give you that dubloon I promised you.", "That's the one I would have chosen, too.", "Grasshoppa learns well.", "You cheated, didn't you?", "Ha! Wrong! Wait, no, never mind.", "Having fun yet?"],
	readyToRender: false,
	invasiveSeen: false,
	hasInvasive: false,
	questIndex: -1,
