...
plantList.push(new PlantObject("Horsetail", "Equisetum", "Horsetail", "", false, ["Small or medium plants", "Can grow rigid, hollow, jointed, fluted, branched, or unbranched", "Leaves are reduced that grow at the collar of a node", "Leaves are triangular and non-photosynthetic", "Plant spreads through underground rhizomes, but also has a strobilus"], 4));
